...
echo "Downloader HTTP:     ${DOWNLOADER_HTTP_IMAGE}"
echo "Downloader Init:     ${DOWNLOADER_INIT_IMAGE}"
echo "----------------------------------------------------"
...
ensure_image "${DOWNLOADER_HTTP_IMAGE}"
ensure_image "${DOWNLOADER_INIT_IMAGE}"
